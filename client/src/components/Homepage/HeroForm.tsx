...
export default function HeroForm() {
    ...
    return (
        <div className="w-full max-w-sm mx-auto rounded-[20px] shadow-md overflow-hidden bg-white">
            {/* Tabs */}
      ...
      ${activeTab === 'buy' ? 'bg-white text-blue-600' : 'bg-gray-100 text-gray-400'}
      rounded-t-[20px]`}
                >
                    Buy
                </button>
                ...
                <button
                    ...
                    className={`w-1/2 py-4 text-sm font-semibold text-center relative z-10 transition-all duration-300
      ${activeTab === 'exchange' ? 'bg-white text-blue-600' : 'bg-gray-100 text-gray-400'}
      rounded-t-[20px]`}
                >
                    Part Exchange
                </button>
                    ...
                    <>
                        ...
                        <div className="flex bg-gray-100 rounded-full p-1 mb-3">
                            <button
                                ...
                                className={`flex-1 py-2 text-sm font-semibold rounded-full transition ${priceType === 'cash' ? 'bg-blue-100 text-black' : 'text-gray-500'
                                    }`}
                            >
                                Cash price
                            </button>
                            <button
                                ...
                                className={`flex-1 py-2 text-sm font-semibold rounded-full transition ${priceType === 'finance' ? 'bg-blue-100 text-black' : 'text-gray-500'
                                    }`}
                            >
                                Finance
                            </button>
